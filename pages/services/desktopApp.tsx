...
import TopSection from '../../public/components/desktopAppComponents/topSection'
import MainContent from '../../public/components/desktopAppComponents/mainContent'
 ...
 const Website = () => {
  ...
  return (
    ...
    <meta name="robots" content="index,follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1"/>
      ...
      <link rel="canonical" href={`${baseUrlPages}/services/desktopApp`}/>
