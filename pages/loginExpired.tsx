   ...
   <>
       <section className="pt-20 pb-32">
                <div className="container text-center">
                    ...
                    <div>
                        <a className="block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded wow animate__animated animate__fadeInUp" data-wow-delay=".5s" href="index.html">Go back to Homepage</a>
