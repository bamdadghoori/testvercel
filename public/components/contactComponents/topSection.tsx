          ...
          <div className="flex flex-wrap items-center -mx-3">
            <div className="w-full lg:w-1/2 px-3">
              <div className="py-12">
                ...
                >
                  <h2
                    className="text-3xl lg:text-4xl mb-4 font-bold font-heading wow animate__animatedanimated animate__fadeIn"
                  >
                    Committed to <span className="text-color-550">People</span>,
...
/>
                ...
                <div className="text-center lg:text-left">
                  <a
                    className="link-button tracking-wide hover-up-2 block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs  text-center font-semibold leading-none  rounded wow animate__animatedanimated animate__fadeInUp"
                   href="#contactUs"
                    >Contact us</a
                  >
            ...
            <div
              className="w-full lg:w-1/2 px-3 lg:bg-colorGray-10 mb-12 lg:mb-0 pb-10"
            >
