          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap mt-12 mb-12">
              <div className="w-full">
                <div
                  className="card px-6 py-10 hover-up-5 top-0 relative wow animate__animated animate__fadeInUp animated w-full"
                  data-wow-delay=".1s"
                >
            ...
            <div
              className="transition duration-300 ease-in-out transform hover:-translate-y-1 flex items-center justify-center mt-12"
            >
              <a
                href="blog.html"
                className="link-button px-4 py-2 mt-2 text-gray-600 transition-colors duration-200 transform  dark:text-gray-200 dark:border-gray-200 dark:hover:bg-gray-700 focus:outline-none"
              >
                Read More Articles
              </a>
            </div>
