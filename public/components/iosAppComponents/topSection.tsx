import React from 'react'
 ...
 const TopSection = () => {
  return (
    <>
    <div
          className="pt-20 pb-8 mb-12 bg-cover bg-no-repeat ios-app-background"
          // style={{"backgroundImage": "url('/assets/imgs/placeholders/ios.png')","backgroundPosition":"center"}}
        >
