    ...
    <>
      ...
      >
        <div className="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
          ...
          <div className="mb-0 font-body text-white flex">Welcome dear {user.Name}</div>
          </div>
            ...
            <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
              ...
              <li className="flex items-center">
                ...
                onClick={(e)=>{e.preventDefault();logout()}}
                  className="block px-0 cursor-pointer py-2 text-sm font-semibold text-white transition-all ease-nav-brand"
                >
              ...
              <li className="flex items-center pl-4 xl:hidden">
                <a
                  onClick={(e) => {
                    e.preventDefault();
                    console.log("state");
                    changeSideBarVisibility(!showSideBar);
                  }}
