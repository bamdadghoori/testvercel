...
//  const SliderSection = () => {
//   return (
//     <section className="pt-20 pb-12  xl:bg-cover bg-bottom background-shadow " >
...
//             >
//               Simple Solution for
//               <span className="text-color-550"> Complex</span> Connections
//             </h2>
//             <p
...
//             <a className=" hover-up-5 top-0 relative inline-block py-4 px-8 text-xs text-white font-semibold leading-none bg-color-400 hover:bg-color-550 rounded" href="#">Show more Testimonials</a>
//           </div>
//     </div>
//   </section>
//   )
...
import React from 'react'
import ImageSlider from '../indexComponents/imageSlider'
 const SliderSection = () => {
  return (
    <>
