import React from 'react'
 ...
 const BusinessPlans = () => {
  return (
    <>
        <section
      className="py-20 bg-top bg-repeat background-shadow"
      style={{"backgroundImage": "url('assets/imgs/backgrounds/intersect-purple.svg')"}}
      
    >
      <div className="container">
        <div className="max-w-lg mx-auto mb-12 text-center">
          <h2
            className="my-2 text-3xl md:text-4xl font-bold font-heading wow animate__animated animate__fadeInUp"
            data-wow-delay=".1s"
          >
            We Consultant to Get <br />
            <span className="text-color-550">Our Business</span> Plan
          </h2>
          <p
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <a href="#" className="w-full md:w-1/2 hover:text-color-550 lg:w-1/4 px-3 mb-6">
            <div
              className="pt-8 px-6 pb-6 text-center card hover-up-2 transition duration-500 wow animate__animated animate__fadeInUp"
              data-wow-delay=".3s"
            >
              <div className="text-color-550 mx-auto mb-4">
                <svg
        ...
        <div className="text-center">
          <a
            className="link-button inline-block py-4 px-8 text-xs   font-semibold leading-none  rounded wow duration-500 animate__fadeInUp"
            data-wow-delay=".3s"
            href="#"
            >More about services</a
          >
        </div>
      </div>
    </section>
